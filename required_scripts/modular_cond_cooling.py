...
def conductive_cooling(run_ID,folder, kappa = 1.22100122100122E-06, B = 0.000, model_type = 17, plotting = "None", save_array = "n",
 save_csv = "n", timestep = 1E11, r_planet = 250000.0, core_size_factor = 0.5, reg_fraction = 0.032, max_time = 400,temp_core_melting = 1200.0,
 olivine_cp = 819.0,olivine_density = 3341.0,return_vars = "n",save_param_file = "y",cmb_conductivity = 3.0,core_cp = 850.0,core_density = 7800.0,
 temp_init = 1600.0,temp_surface = 250.0,core_latent_heat = 270000.0,kappa_reg = 5.0E-8,dr = 1000.0,reg_percent = "y",cond_constant="y",
 density_constant="y",heat_cap_constant = "y",non_lin_term="y",record_timings = "n"):
    ...
    optional arguments:
        ...
        kappa: default is 5E-7
            diffusivity that sets the conductivity or in the case of temperature
        ...
        model_type: default is 4.
            ...
            7: for constant conductivity approximated to analytical soln of sphere
            8: simple variable conductivity with separated components but non-lin = 0
        ...
        save_csv: default is "n"
            ...
            "n": do not save csv files. Data can be pulled from array above if "y".
        ...
        reg_fraction: default is 0.0
            fraction of the total radius that is regolith. To match Bryson, set to 0.04

        max_time: default is 400 Myr
            This is the total time the model will run for. Suggested values for different radii are given below in a comment.

        save_param_file: default is "y"
            Select y if you want a text file output at the end of each run with parameters
...
#            k_0[i] = k0_reg
    ...
    #     temperatures, coretemp, latent, temp_list_mid_mantle,temp_list_shal,temp_list_cmb_5,A_1list,B_1list,C_1list,delt_list,A_1listcmb,B_1listcmb,C_1listcmb,delt_listcmb,A_1listshal,B_1listshal,C_1listshal,delt_listshal = t_s.timestepping_variableCp_variablek_sep_terms_realistic_with_regolith(latent,temp_init, temp_core_melting, temp_surface,cmb_conductivity, temperatures, dr, coretemp, timestep,core_density, core_cp, r_core, core_latent_heat, radii,times, kappas, p, where_regolith,kappa_reg)
       ...
       import modular_temp_timestepping as mtt
       temperatures, coretemp, latent, temp_list_mid_mantle,temp_list_shal,temp_list_cmb_5,A_1list,B_1list,C_1list,delt_list,A_1listcmb,B_1listcmb,C_1listcmb,delt_listcmb,A_1listshal,B_1listshal,C_1listshal,delt_listshal = mtt.discretisation(latent,temp_init, temp_core_melting, temp_surface,
                 cmb_conductivity, p, c, temperatures, dr, coretemp, timestep,
                 core_density, core_cp, r_core, core_latent_heat, radii,
                 times, kappas, where_regolith,kappa_reg,cond_constant,
 density_constant,heat_cap_constant,non_lin_term)
       
    elif(model_type==18):
       import modular_temp_timestepping as mtt
       temperatures, coretemp, latent, temp_list_mid_mantle,temp_list_shal,temp_list_cmb_5,A_1list,B_1list,C_1list,delt_list,A_1listcmb,B_1listcmb,C_1listcmb,delt_listcmb,A_1listshal,B_1listshal,C_1listshal,delt_listshal = mtt.simple_discretisation(latent,temp_init, temp_core_melting, temp_surface,
                 cmb_conductivity, p, c, B, temperatures, dr, coretemp, timestep,
                 core_density, core_cp, r_core, core_latent_heat, radii,
                 times, kappas, where_regolith,kappa_reg,cond_constant,
 density_constant,heat_cap_constant,non_lin_term)
    ...
    core_frozen, times_frozen, time_core_frozen, fully_frozen = c_c.core_freezing(coretemp, max_time, times, latent, temp_core_melting,timestep)
    ...
    Esquel_Depth = (c_d.Critical_Depth(Esquel_cooling_rate, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Imilac_Depth = (c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Esq_timing = (c_d.Critical_Depth(Esquel_cooling_rate, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
    Im_timing = (c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
    Esq_result = (c_d.Critical_Depth(Esquel_cooling_rate, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[1]
    Im_result = (c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[1]
    with open("output_runs/"+ str(folder)+"/"+str(run_ID)+"Im_Esq_result.pickle",'wb') as f:
            pickle.dump([Esq_result,Im_result],f)
    print("Im: " +str(Im_result))
    print("Esq: "+str(Esq_result))


    Brenham1_Depth = (c_d.Critical_Depth(Brenham1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    GlorM1_Depth = (c_d.Critical_Depth(Glorietta_Mountain1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Seymchan1_Depth = (c_d.Critical_Depth(Seymchan1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]


    Dora_Depth = (c_d.Critical_Depth(Dora_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Finmarken_Depth = (c_d.Critical_Depth(Finmarken_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Giroux_Depth = (c_d.Critical_Depth(Giroux_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    SBend_Depth = (c_d.Critical_Depth(SBend_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Springwater_Depth = (c_d.Critical_Depth(Springwater_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Admire_Depth = (c_d.Critical_Depth(Admire_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Brahin_Depth = (c_d.Critical_Depth(Brahin_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    Fukang_Depth = (c_d.Critical_Depth(Fukang_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]

    #### other timings #####
    if record_timings == "y":
        Brenham1_t = (c_d.Critical_Depth(Brenham1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        GlorM1_t = (c_d.Critical_Depth(Glorietta_Mountain1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Seymchan1_t = (c_d.Critical_Depth(Seymchan1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
    
    
        Dora_t = (c_d.Critical_Depth(Dora_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Finmarken_t = (c_d.Critical_Depth(Finmarken_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Giroux_t = (c_d.Critical_Depth(Giroux_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        SBend_t = (c_d.Critical_Depth(SBend_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Springwater_t = (c_d.Critical_Depth(Springwater_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Admire_t = (c_d.Critical_Depth(Admire_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Brahin_t = (c_d.Critical_Depth(Brahin_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]
        Fukang_t = (c_d.Critical_Depth(Fukang_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[3]    

        with open("output_runs/"+ str(folder)+"/"+str(run_ID)+"times.pickle",'wb') as f:
            pickle.dump([Esq_timing,Im_timing,Brenham1_t,GlorM1_t,Seymchan1_t,Dora_t, Finmarken_t,Giroux_t,SBend_t,Springwater_t,Admire_t,Brahin_t,Fukang_t],f)
    else:
        pass
    ...
    ol_depth_low= (c_d.Critical_Depth_ol(Miyamoto1997_low, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    ol_depth_high = (c_d.Critical_Depth_ol(Miyamoto1997_high,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen))[0]
    ...
    if (save_array == "y"):
        with open("output_runs/"+ str(folder)+"/"+str(run_ID)+"depths.pickle",'wb') as f:
            pickle.dump([Esquel_Depth,Imilac_Depth,Brenham1_Depth,GlorM1_Depth,Seymchan1_Depth,Dora_Depth,Finmarken_Depth,Giroux_Depth,SBend_Depth,Springwater_Depth,Admire_Depth,Brahin_Depth,Fukang_Depth,ol_depth_low,ol_depth_high,ol_depth_v_low,Esquel_Depth_test,Imilac_cooling_rate,Esquel_cooling_rate],f)
    else:
        pass
    ...
    #Depth_list_names = ["Esquel","Imilac","Brenham","GloriettaMountain","Seymchan","Dora","Finmarken","Giroux","SouthBend","Springwater","Admire","Brahin","Fukang","ol_depth_low","ol_depth_high","ol_depth_v_low","Esquel_Depth_test"]
    #
    #with open("output_runs/"+ str(folder)+"/depthlist_"+str(run_ID)+".csv","w") as f:
    #    writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
    #    writer.writerow(Depth_list)
    #
    #with open("output_runs/"+ str(folder)+"/depthlistnames_"+str(meteorite_depthlist_ID)+".csv","w") as f:
    #    writer = csv.writer(f, delimiter='\n', quoting = csv.QUOTE_ALL)#,quoting=csv.QUOTE_NONE)
    #    writer.writerow(Depth_list_names)

    ##########
    # Timing #
    #CAN COMMENT OUT THIS SECTION IF YOU DON'T NEED THIS INFO!
    ##########
    #
    #Esquel_time= (c_d.Critical_Depth(Esquel_cooling_rate, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11)
    #Imilac_time = (c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11)
    #
    #Brenham1_time = (c_d.Critical_Depth(Brenham1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11)
    #GlorM1_time= (c_d.Critical_Depth(Glorietta_Mountain1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11)
    #Seymchan1_time = (c_d.Critical_Depth(Seymchan1_cr, temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11)
    #
    #
    #print("B=", B)
    #print("Imilac:", "Depth =", c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[0], "km",",", c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[1],
    #(c_d.Critical_Depth(Imilac_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11) )
    #print("Esquel:", "Depth=" ,c_d.Critical_Depth(Esquel_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[0],"km",",", c_d.Critical_Depth(Esquel_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[1],
    #(c_d.Critical_Depth(Esquel_cooling_rate,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11))
    #
    #print("Brenham:", "Depth=" ,c_d.Critical_Depth(Brenham1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[0],"km",",", c_d.Critical_Depth(Brenham1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[1],
    #(c_d.Critical_Depth(Brenham1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11))
    #
    #print("Glorietta Mountain:", "Depth=" ,c_d.Critical_Depth(Glorietta_Mountain1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[0],"km",",", c_d.Critical_Depth(Glorietta_Mountain1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[1],
    #(c_d.Critical_Depth(Glorietta_Mountain1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11))
    #
    #print("Seymchan:", "Depth=" ,c_d.Critical_Depth(Seymchan1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[0],"km",",", c_d.Critical_Depth(Seymchan1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[1],
    #(c_d.Critical_Depth(Seymchan1_cr,temperatures,dT_by_dt, radii, r_planet, core_size_factor,time_core_frozen, fully_frozen)[3])/(10**11))
    ...
    if (plotting == "both"):
        ...
        temp_plotting_formatted.temperature_plot(temperatures, coretemp, Esquel_Depth, Imilac_Depth,Brenham1_Depth,Seymchan1_Depth,GlorM1_Depth,Admire_Depth, Brahin_Depth,Fukang_Depth, r_core, max_time, time_core_frozen, fully_frozen, r_planet,run_ID)

        temp_plotting_formatted.cooling_rate_plot(dT_by_dt, dT_by_dt_core, Imilac_cooling_rate, Esquel_cooling_rate, Esquel_Depth, Imilac_Depth, max_time, time_core_frozen, fully_frozen, r_planet, r_core, temperatures, coretemp,run_ID)

    elif (plotting == "temp"):
        print("Beginning plotting temp")
        import temp_plotting_formatted
        temp_plotting_formatted.temperature_plot(temperatures, coretemp, Esquel_Depth, Imilac_Depth,Brenham1_Depth,Seymchan1_Depth,GlorM1_Depth,Admire_Depth, Brahin_Depth,Fukang_Depth, r_core, max_time, time_core_frozen, fully_frozen, r_planet,run_ID,timestep)
    ...
    if save_csv == "y":
        ...
        with open("output_runs/"+ str(folder)+"/temp_list_mid_mantle_"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(temp_list_mid_mantle)

        with open("output_runs/"+ str(folder)+"/temp_list_cmb_5_"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
    ...
    if (save_csv == "y") and (model_type == 5 or 4 or 7 or 8 or 9 or 10 or 11 or 17 or 18):
        print("saving time output to csv")
        with open("output_runs/"+ str(folder)+"/time_output_"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
    ...
    if (model_type == 5):
        ...
        with open("output_runs/"+ str(folder)+"/B_1_mm"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(B_1list)

        with open("output_runs/"+ str(folder)+"/C_1_mm"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(C_1list)

        with open("output_runs/"+ str(folder)+"/delt_mm"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(delt_list)


        # CMB:
        with open("output_runs/"+ str(folder)+"/A_1_cmb"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(A_1listcmb)

        with open("output_runs/"+ str(folder)+"/B_1_cmb"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(B_1listcmb)

        with open("output_runs/"+ str(folder)+"/C_1_cmb"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(C_1listcmb)

        with open("output_runs/"+ str(folder)+"/delt_cmb"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(delt_listcmb)

        # shallow:

        with open("output_runs/"+ str(folder)+"/A_1_shal"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(A_1listshal)

        with open("output_runs/"+ str(folder)+"/B_1_shal"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(B_1listshal)

        with open("output_runs/"+ str(folder)+"/C_1_shal"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(C_1listshal)

        with open("output_runs/"+ str(folder)+"/delt_shal"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(delt_listshal)


    elif (save_csv == "y") and (model_type == 4 or 7 or 8 or 9 or 10 or 11 or 17 or 18):
        with open("output_runs/"+ str(folder)+"/A_1_mm"+str(run_ID)+".csv","w") as f:
            writer = csv.writer(f, delimiter='\n',quoting=csv.QUOTE_NONE)
            writer.writerow(A_1list)
    ...
    if (save_array == "y"):
        with open("output_runs/"+ str(folder)+"/"+str(run_ID)+"other_vars.pickle",'wb') as f:
            pickle.dump([r_core,max_time,time_core_frozen,fully_frozen,r_planet,dr],f)
        with open("output_runs/"+ str(folder)+"/"+str(run_ID)+"basic_output.pickle",'wb') as f:
            pickle.dump([max_time,time_core_frozen,fully_frozen,B,k0_mantle,kappa,Esquel_Depth,Imilac_Depth, Esq_timing, Im_timing],f)
...
#    print("Actual timestep:", timestep, "\n", "Courant criterion at CMB:",time_check1, "\n", "Courant criterion at surface:", time_check2, "\n")
    ...
    if save_param_file == "y":
        ...
        f = open("output_runs/"+ str(folder)+"/params_"+str(run_ID)+".txt",'w')
        f.write('PARAMETERS \n##############################'+
        '\nrun_ID = '+str(run_ID)+
