...
class IsothermalOutwardsSolidification:
    """
    Core class  to represent and manipulate core temperature and latent heat.

    Based on the outwardly-solidifying simple core from Nichols et al. (2021,
    doi: 10.1029/2021JE006900) and Nimmo (2009, doi: 10.1029/2009GL037997).
