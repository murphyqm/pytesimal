...
def test_mtt_discretisation():
    ...
    core_values = core_functions.IsothermalEutecticCore(temp=1800.0, melt=1200.0,
                                                        outer_r=10000.0, inner_r=0, rho=7800.0, cp=850.0,
    ...
    (temperatures,
     ...
     # C_1listshal,
     # delt_listshal,
     ) = mtt.discretisation(core_values=core_values,
                            latent=[],
                            temp_init=1800.0,
                            core_temp_init=1800,
